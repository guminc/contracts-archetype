...
describe("FactoryErc1155", function () {
  ...
  it("should let you change the archetype implementation", async function () {
    ...
    ArchetypeLogicErc1155 = await ethers.getContractFactory("ArchetypeLogicErc1155");
    archetypeLogic = await ArchetypeLogicErc1155.deploy();
  ...
  it("test erc115 specific tokenId mints", async function () {
    ...
    await expect(
      nftMint
        .connect(minter2)
        .mintToken({ key: ethers.constants.HashZero, proof: [] }, 1, 3, ZERO, "0x", {
          value: 0,
        })
